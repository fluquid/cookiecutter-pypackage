...
version = {{ cookiecutter.project_package }}.__version__
# The full version, including alpha/beta/rc tags.
release = {{ cookiecutter.project_package }}.__version__
...
htmlhelp_basename = '{{ cookiecutter.project_package }}doc'
...
# [howto/manual]).
latex_documents = [
    ('index', '{{ cookiecutter.project_package}}.tex',
...
man_pages = [
    ('index', '{{ cookiecutter.project_package }}',
     u'{{ cookiecutter.project_name }} Documentation',
